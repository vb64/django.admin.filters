...
- [django-admin-list-filter-dropdown](https://github.com/mrts/django-admin-list-filter-dropdown) фильтр как "выпадающий список" для боковой панели в админке Django.
